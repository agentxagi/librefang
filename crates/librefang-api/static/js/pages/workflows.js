  ...
  return {
    ...
    async createWorkflow() {
      ...
      try {
        ...
        LibreFangToast.success('Workflow "' + wfName + '" created');
        await this.loadWorkflows();
      } catch(e) {
        LibreFangToast.error('Failed to create workflow: ' + e.message);
      }
    },
    ...
    async executeWorkflow() {
      ...
      try {
        ...
        LibreFangToast.success('Workflow completed');
      } catch(e) {
        this.runResult = 'Error: ' + e.message;
        LibreFangToast.error('Workflow failed: ' + e.message);
      }
      this.running = false;
    },
    ...
    async viewRuns(wf) {
      try {
        ...
        LibreFangToast.error('Failed to load run history: ' + e.message);
      }
    }
  };
}
